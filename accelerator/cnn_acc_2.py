...
class cnn_acc_2:
    # Arria10 vc707
    # bandwidth was 512 freq was 100
    # NetBand=5GB/s
    # DDR = 1GB
    # DDR_WEI = 80%
    # Dtype = 32bit
    # Freq = 100
    # Bandwidth = 512
    def __init__(self,  throughput = 61.62, NetBand=0.5, DDR = 1, DDR_WEI = 0.8, Dtype=32, Freq=100, Bandwidth=512, Tm=32, Tn=32, Tr=16, Tc=14, Tr_=16, Tc_=16, power=18.6):
