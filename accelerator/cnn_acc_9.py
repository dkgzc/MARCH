...
class cnn_acc_9:
    ...
    # Freq = 250
    # Bandwidth = 512
    # throughput was 360, scale to 36
    def __init__(self, throughput=36, NetBand=0.5, DDR=1, DDR_WEI=0.8, Dtype=32, Freq=200, Bandwidth=512, Tm=32, Tn=32,
                 Tr=16, Tc=14, Tr_=16, Tc_=16, power=30):
