...
class lstm_acc_pynq:
    ...
    # Bandwidth = 256
    # bandwidth was 256
    def __init__(self, throughput=0.8, NetBand=0.5, DDR=0.256, DDR_WEI=0.8, Dtype=32, Freq=150, Bandwidth=256, power = 2.29):
        self.Hidden = None
        self.Dimen = None
        self.Iter = None
    ...
    def getDataInPerf(self, WEItrans, IFMtrans, OFMtrans):
        ...
        if WEItrans==True and IFMtrans==True:
            ...
            tDataIn = (4*self.Hidden * self.Dimen + 4*self.Hidden * self.Hidden) * self.Dtype / DDR2MemBand
