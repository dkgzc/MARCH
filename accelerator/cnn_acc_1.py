# -*- coding: utf-8 -*-
# author: Xinyi Zhang time:7/4/2021

from math import *

class cnn_acc_1:
    # Arria10 GX1150
    # bandwidth was 512 freq was 385
    # NetBand=5GB/s
    # DDR = 8GB
    # DDR_WEI = 80% of the DDR space is reserved for weights
    # Dtype = 32bit
    # Freq = 370MHz
    # Bandwidth = 512
    # throughput = 866  scale to 86.6
    def __init__(self, throughput = 86.6, NetBand=0.5, DDR = 2, DDR_WEI = 0.5, Dtype=32, Freq=370, Bandwidth=512, Tm=32, Tn=32, Tr=16, Tc=14, Tr_=16, Tc_=16, power=37.46):
...
if __name__ == "__main__":
    ...
    print(LatSec, Th, '\n')
    LatSec, Th = acc.getLayerPerf(WEItrans=False, IFMtrans=False, OFMtrans=True)
    print(LatSec, Th, '\n')
    LatSec, Th = acc.getLayerPerf(WEItrans=False, IFMtrans=False, OFMtrans=False)
    print(LatSec, Th, '\n')
