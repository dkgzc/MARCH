...
class cnn_acc_6:
    ...
    # Freq = 150
    # Bandwidth = 512
    def __init__(self,  throughput = 73, NetBand=0.5, DDR = 2, DDR_WEI = 0.8, Dtype=32, Freq=100, Bandwidth=512, Tm=32, Tn=32, Tr=16, Tc=14, Tr_=16, Tc_=16, power=25):
